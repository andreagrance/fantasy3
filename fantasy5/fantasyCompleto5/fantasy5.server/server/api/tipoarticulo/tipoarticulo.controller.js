...
import {tipoarticulo} from '../../sqldb';
...
export function create(req, res) {
  return tipoarticulo.create(req.body)
...
export function upsert(req, res) {
  ...
  return tipoarticulo.upsert(req.body, {
    where: {
      _id: req.params.id
    }
  })
